...
from training.stam.coordinate_transform import (
    crs_to_epsg,
...
from training.stam.exceptions import CRSMismatchError
from training.stam.coordinate_transform import assert_same_crs
