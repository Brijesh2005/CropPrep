...
from training.dataset_manager.dataset_registry import SQLiteRegistry
from training.dataset_manager.models import DatasetStatus
...
def test_unknown_update_field_rejected(tmp_path: Path):
    ...
    from training.dataset_manager.exceptions import RegistryError
