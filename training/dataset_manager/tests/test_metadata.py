...
from training.dataset_manager.exceptions import InvalidMetadataError
from training.dataset_manager.image_loader import RasterioImageLoader
from training.dataset_manager.metadata import MetadataGeneratorImpl, SQLiteMetadataStore
from training.dataset_manager.models import IndexType
from training.dataset_manager.scanner import DatasetScanner


def _generate(root: Path, db_path: Path, **config):
    from training.dataset_manager.config import MetadataConfig
...
def test_unexpected_query_filter_rejected(synthetic_dataset: Path, tmp_path: Path):
    from training.dataset_manager.metadata import SQLiteMetadataStore
