...
from training.training import TrainingConfig, load_training_config, save_training_template
from training.training.exceptions import TrainingConfigurationError
...
def test_optimizer_name_validated_at_build_time():
    ...
    with pytest.raises(Exception):
        from training.training import build_optimizer
