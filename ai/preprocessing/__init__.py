...
Converts :class:`~services.spatial_alignment.observation.AgriculturalObservation`
...
Example::
    ...
    from ai.preprocessing import Preprocessor, CropFusionDataset, build_dataloader, split_observations
