...
from ai.preprocessing.validators import filter_observations
...
def test_quality_rejection(observations, preprocessing_config):
    from ai.preprocessing.config import QualityConfig
...
def test_from_config(tmp_path):
    from ai.preprocessing import save_preprocessing_template
