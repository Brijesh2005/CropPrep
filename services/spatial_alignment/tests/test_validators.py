...
from services.spatial_alignment.config import QualityConfig
from services.spatial_alignment.observation import (
    ImagePairRef,
    ImageRecordRef,
    LocationInfo,
    SequenceInfo,
...
from services.spatial_alignment.validators import assess_quality
